            ...
            <form class="row g-2 align-items-center" method="GET">
              ...
              <div class="col-12 col-md-8">
                <div class="input-group">
                  ...
                  <input type="text" name="search" class="form-control" placeholder="Search by company or contact person">
                </div>
              </div>
              <div class="col-12 col-md-4 text-md-end">
                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#addClientModal" style="background-color:#2F4858; border-color:#2F4858;">
            ...
            <table class="table table-hover align-middle mb-0">
              ...
              <tbody>
                <?php if (empty($clients)): ?>
                  <tr><td colspan="5" class="text-center text-secondary py-4">No clients found.</td></tr>
                <?php else: ?>
      ...
      <?php elseif ($activeTab === 'requests'): ?>
        ...
        <section class="client-management-toolbar card border-0 shadow-sm mb-3">
          <div class="card-body p-2 p-md-3 d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addRequestModal" style="background-color:#2F4858; border-color:#2F4858;">
