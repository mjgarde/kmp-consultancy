...
<aside class="dashboard-sidebar offcanvas-lg offcanvas-start bg-white border-end d-flex flex-column" tabindex="-1" id="sidebarOffcanvas">
  ...
  <nav class="dashboard-sidebar-scroll flex-grow-1 py-3 px-3">
    ...
    <ul class="dashboard-sidebar-menu nav flex-column mb-4">
      ...
      <li class="nav-item mb-1">
        <a href="schedule_tasks.php" title="My Schedule / Tasks" class="nav-link <?= navActive('schedule_tasks.php', $currentPage) ?> d-flex align-items-center gap-3 rounded-3 px-3 py-2">
          <i class="fa-solid fa-calendar-days" style="width:18px;"></i> <span class="sidebar-text">My Schedule / Tasks</span>
        </a>
      </li>
    </ul>
