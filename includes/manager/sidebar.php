<?php
$managerFullname = $_SESSION['fullname'] ?? 'Manager';
...
<aside class="dashboard-sidebar offcanvas-lg offcanvas-start bg-white border-end d-flex flex-column" tabindex="-1" id="sidebarOffcanvas">
  ...
  <div class="dashboard-sidebar-footer border-top p-3">
    <div class="dropdown dropup">
      <button type="button" class="btn btn-link p-0 w-100 text-start text-decoration-none dropdown-toggle d-flex align-items-center gap-3 text-dark" data-bs-toggle="dropdown" aria-expanded="false" title="<?= htmlspecialchars($managerFullname) ?>">
