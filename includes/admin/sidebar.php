<?php
$adminFullname = $_SESSION['fullname'] ?? 'Administrator';
...
<aside class="dashboard-sidebar offcanvas-lg offcanvas-start bg-white border-end d-flex flex-column" tabindex="-1" id="sidebarOffcanvas">
  ...
  <nav class="dashboard-sidebar-scroll flex-grow-1 py-3 px-3">
    ...
    <ul class="dashboard-sidebar-menu nav flex-column">
      <li class="nav-item mb-1">
        <a href="user_management.php" title="User Management" class="nav-link <?= navActive('user_management.php', $currentPage) ?> d-flex align-items-center gap-3 rounded-3 px-3 py-2">
          <i class="fa-solid fa-user-gear" style="width:18px;"></i> <span class="sidebar-text">User Management</span>
        </a>
      </li>
      <li class="nav-item mb-1">
        <a href="reports_analytics.php" title="Reports &amp; Analytics" class="nav-link <?= navActive('reports_analytics.php', $currentPage) ?> d-flex align-items-center gap-3 rounded-3 px-3 py-2">
          <i class="fa-solid fa-chart-line" style="width:18px;"></i> <span class="sidebar-text">Reports &amp; Analytics</span>
        </a>
      </li>
      <li class="nav-item mb-1">
        <a href="activity_logs.php" title="Activity Logs" class="nav-link <?= navActive('activity_logs.php', $currentPage) ?> d-flex align-items-center gap-3 rounded-3 px-3 py-2">
          <i class="fa-solid fa-clock-rotate-left" style="width:18px;"></i> <span class="sidebar-text">Activity Logs</span>
        </a>
      </li>
    </ul>
  ...
  <div class="dashboard-sidebar-footer border-top p-3">
    <div class="dropdown dropup">
      <button type="button" class="btn btn-link p-0 w-100 text-start text-decoration-none dropdown-toggle d-flex align-items-center gap-3 text-dark" data-bs-toggle="dropdown" aria-expanded="false" title="<?= htmlspecialchars($adminFullname) ?>">
